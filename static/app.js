...
const photoTypeTranslations = {
  ...
  "Կնունքի նկարահանում": {
    hy: "Կնունքի նկարահանում",
    ru: "Съемка крещения",
    en: "Baptism event coverage",
  },
  "Նշանադրության նկարահանում": {
    hy: "Նշանադրության նկարահանում",
    ru: "Съемка помолвки",
    en: "Engagement event coverage",
  },
  "Կորպորատիվ միջոցառման նկարահանում": {
    hy: "Կորպորատիվ միջոցառման նկարահանում",
    ru: "Съемка корпоративного мероприятия",
    en: "Corporate event coverage",
  },
  "Ավարտական միջոցառման նկարահանում": {
    hy: "Ավարտական միջոցառման նկարահանում",
    ru: "Съемка выпускного",
    en: "Graduation event coverage",
  },
  "Դպրոցական / մանկապարտեզի միջոցառման նկարահանում": {
    hy: "Դպրոցական / մանկապարտեզի միջոցառման նկարահանում",
    ru: "Съемка школьного / детсадовского мероприятия",
    en: "School / kindergarten event coverage",
  },
  "Համերգի / բեմական միջոցառման նկարահանում": {
    hy: "Համերգի / բեմական միջոցառման նկարահանում",
    ru: "Съемка концерта / сценического мероприятия",
    en: "Concert / stage event coverage",
  },
};
